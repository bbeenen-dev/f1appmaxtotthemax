            ...
            <div className="space-y-12">
              ...
              <div className="space-y-4">
                <div className="flex flex-col gap-1">
                  ...
                  <p className="text-slate-400 text-lg md:text-xl font-medium leading-relaxed italic max-w-2xl border-l-2 border-[#e10600] pl-6">
            De prijzenpot van 130 euro wordt beheerd door Boudewijn in een Bitcoin Wallet! Verdeling prijzenpot: 80% Winnaar 20% Runner-up
          </p>
                </div>
               </div>
            ...
            <div className="grid gap-12">
              ...
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-slate-900 pb-8">
                ...
                <div className="flex flex-col items-start gap-1">
                  <p className="font-f1 font-black italic uppercase text-xl text-white">
                    5 PT <span className="text-slate-500 text-sm tracking-normal font-bold ml-1">per goede voorspelling</span>
                  </p>
                  <p className="font-f1 font-black italic uppercase text-xl text-white">
                    2 PT <span className="text-slate-500 text-sm tracking-normal font-bold ml-1">één plek ernaast</span>
                  </p>
                </div>
              </div>
